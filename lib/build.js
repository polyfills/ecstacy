...
Ecstacy.prototype.build = function (useragent) {
  var self = this
...
Ecstacy.prototype._detect = function () {
...
Ecstacy.prototype._transform = function (useragent) {
...
Ecstacy.prototype._buildOriginal = function () {
...
Ecstacy.prototype._buildTransform = function (transforms) {
  ...
  var result_map = this.map
    ? utils.applySourceMap(result.map, this.map)
